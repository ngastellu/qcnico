...
pos1 = np.zeros((frames.shape[0], 57717, 3))
pos2 = np.zeros((frames.shape[0], 57717, 3))

frames100 = stream_lammps_traj(f100, frames[0], frames[-1], 10000, start_file=10000, step_file=10)
